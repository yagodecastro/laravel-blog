...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container">
            <a class="navbar-brand hessam-blog-title" href="{{ route('hessamcms.admin.index') }}">
        ...
        <div class="container">
            <div class='row full-width-div nav-bar-full'>
                <div class='list-group-color'>
                    @include("hessamcms_admin::layouts.sidebar")
                ...
                <div class='col-md-9 main-content'>
                    ...
                    @if(\HessamCMS\Helpers::has_flashed_message())
                        <div class='alert alert-info'>
                            <h3>{{\HessamCMS\Helpers::pull_flashed_message() }}</h3>
                        </div>
                    @endif
